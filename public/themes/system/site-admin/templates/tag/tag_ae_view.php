	...
	<div id="tabs" class="page-tabs tag-tabs">
		...
		<div id="tabs-1">
			...
			<div class="control-group">
				<label class="control-label" for="t_name"><?php echo lang('tag_name'); ?>: <span class="txt_require">*</span></label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label" for="t_description"><?php echo lang('tag_description'); ?>: </label>
				<div class="controls">
