<article class="general-page-container col-md-12">
	...
	<?php echo form_open_multipart('', array('class' => 'form_coupon')); ?> 
		...
		<div class="" >
			...
			<input class="cover_img_name1" type="hidden" name="image_coupon" value="<?php echo $account_avatar = ( ! empty( $show_data->account_avatar ) ) ? $show_data->account_avatar : '' ; ?>">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="persen span4" name="name_coupon" value="<?php if (isset($show_data->name)) {echo $show_data->name;} ?>"  id="" /><span></span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="persen" name="discount" value="<?php if (isset($show_data->name)) {echo $show_data->name;} ?>"  id="" /><span> %</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea name="detail" style="width: 35em; height: 8em;"></textarea>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="span3 persen" id="datepicker" name="start_date" value=""  id="" /><span></span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="span3 persen" name="end_date" id="datepicker2" value=""  id="" /><span></span>
			</div>
		</div>
